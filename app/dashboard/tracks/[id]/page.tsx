...
export default async function TrackDashboard({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className={styles.dashboard}>
    ...
    <header className={styles.topbar}>
      <a href="/dashboard" className={styles.brand}>REVIBE <b>ANALYSIS DESK</b></a>
      <form action="/dashboard" className={styles.miniLookup}><input name="id" inputMode="numeric" placeholder="Track ID" /><button>Inspect</button></form>
      <ThemeToggle />
